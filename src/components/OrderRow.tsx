  ...
  return (
    <>
      <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
        ...
        <TableCell
          align="right"
          className={`${paymentStatus === "SUCCESS" ? "text-green-500" : "text-gray-400"
            }`}
        >
      ...
      >
        <SetOrderStatus
          orderId={openOrderId}
          orderNo={orderNo}
          customerName={`${customer?.fullName && customer?.fullName} ${!customer?.fullName ? customer?.name?.firstname : ""
